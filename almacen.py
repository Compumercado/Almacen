...
# --------PEDIDOS--------
    ...
    if not bajos:
        ...
        with col_p2:
        #---    st.download_button("📊 Descargar Pedidos Excel", exportar_excel_general(df_bajos, "Pedidos"), "reporte_pedidos.xlsx", mime="applica
st.download_button(
    label="📊 Descargar Pedidos Excel",
    data=exportar_excel_general(df_bajos, "Pedidos"),
